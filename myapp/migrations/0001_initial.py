    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postcode', models.CharField(max_length=10, verbose_name='Почтовый код')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('image', models.ImageField(upload_to='event_images/', verbose_name='Превью изображение')),
                ('date', models.DateTimeField(verbose_name='Дата мероприятия')),
                ('organizations', models.ManyToManyField(related_name='organizations', to='myapp.organization', verbose_name='Организации участвующие в мероприятии')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('organizations', models.ManyToManyField(related_name='users', to='myapp.organization')),
            ],
            options={
